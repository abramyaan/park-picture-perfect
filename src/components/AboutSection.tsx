      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-4">
            <strong className="text-foreground">«В Кадре»</strong> — это команда профессионалов, специализирующаяся на предоставлении качественных фотоуслуг в парках и общественных пространствах.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed mb-4">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Наша миссия — превращать каждый визит в парк в яркое событие, о котором хочется рассказать друзьям.
          </p>
        </div>
